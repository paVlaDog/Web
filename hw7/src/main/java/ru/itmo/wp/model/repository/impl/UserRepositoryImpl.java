...
public class UserRepositoryImpl extends ElementRepository implements UserRepository {
    ...
    @Override
    public void changeAdminById(long id, boolean admin) {
        baseChange(new LinkedHashSet<>(Arrays.asList(new Pair("boolean", admin), new Pair("long", id))),
    ...
    public void save(User user, String passwordSha) {
        baseSave(user, new LinkedHashSet<>(Arrays.asList(
                ...
                new Pair("boolean", user.isAdmin())
        )), "INSERT INTO `User` (`login`, `passwordSha`, `email`, `admin`, `creationTime`) VALUES (?, ?, ?, ?, NOW())");
    }
